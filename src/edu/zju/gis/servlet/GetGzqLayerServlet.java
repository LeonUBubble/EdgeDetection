...
/**
 * Servlet implementation class GetGzqLayerServlet GetGzqLayerServlet
 */
public class GetGzqLayerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetGzqLayerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String geojson = null;
		try {
			geojson = RequestDealUtils.getGzqDataFromHBase(extent);
		} catch (Exception e) {
			e.printStackTrace();
		}
